...
from utils.visualize import plot_loss_vs_iteration, plot_lambda_vs_iteration, plot_lambda_vs_val_loss


#Add command-line arguments
parser = argparse.ArgumentParser(description='Ridge Regression')
parser.add_argument('--model', type=str, default='normal', choices=['normal', 'hg'], help='Model type (default: normal)')
parser.add_argument('--lambda_init', type=float, default=0.5, help='Initial value of lambda (default: 0.5)')
parser.add_argument('--lr', type=float, default=1e-3, help='Learning rate (default: 1e-3)')
parser.add_argument('--num_epochs', type=int, default=15001, help='Number of epochs (default: 15001)')
